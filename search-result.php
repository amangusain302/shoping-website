    ...
    <div class="container">
        <div class="for-center-car">
            <div class="container-heading-car">
                <span><i class="fas fa-search"></i> Results</span>
            </div>
        </div>
        <?php
        if($search_data==null)
        ...
        ?>
        <div class="noresult">
        <lottie-player src="https://assets10.lottiefiles.com/packages/lf20_tmsiddoc.json"  background="transparent"  speed="1"  style="width: 400px; height: 400px;"  loop autoplay></lottie-player>
