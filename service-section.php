...
<body>
    ...
    <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff" class="swiper mySwiper">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide" style="background-image: url(image/slider/1.jpg);    height: 40vh;
            background-position: center;
            background-size: cover;">
            ...
            <div class="swiper-slide" style="background-image: url(image/slider/2.jpg);     height: 40vh;
    ...
    <!-- services -->
    <!-- <div class="container">
        <div class="for-center-all-service">
            <div class="container-heading-all-service">
                <span> ALL SERVICES</span>
            </div>
        </div>
    </div>
    <div class="img-service">
        <a href="mobile-serivce"><img src="image/service/mobile-service.jpg" alt="" width="100%"></a>
    </div><br>
    <div class="img-service">
        <a href="bike-serivce"><img src="image/service/motorcycle.jpg" width="100%" alt=""></a>
    </div><br>
    <div class="img-service">
        <a href="car-serivce"><img src="image/service/newcar.jpg" alt="" width="100%"></a>
    </div>
    <br><br><br> -->
            ...
            <di class="row p-0 m-0">
                <div class="col-md-3 col-12">
                    <div class="footerlogo">
                        <img src="image/logo/FB.png" alt="logo" class="footer-logo">
                    </div>
                    <div class="pp">
