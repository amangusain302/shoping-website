...
<div class="container post border p-0">
        ...
        <div class="container set-pd-post">
            ...
            <br>
            <form action="http://<?php echo $server_name; ?>/fixbuy/api-call/mobile-product-api-call.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="main_category" placeholder="MAIN CATEGORY*" class="form-control set-pd-input-post" value="mobiles"><br>
        ...
        <div class="container set-pd-post">
            ...
            <div class="post-pr">
                <input type="submit" value="POST NOW" name="submit" ></input>
            </div>
            </form>
